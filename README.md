...
## Why?
because scientific computing (link to explanation post). Briefly, the goal is cater to a workflow that starts with local development, and seamlesslessly brings more compute power on demand.
